(function initUnifiedNavigationShell() {
  ...
  const icons = {
    ...
    badgeManagement: '<svg class="nav-icon" viewBox="0 0 18 18" fill="none" aria-hidden="true"><path d="M14.75 8.25V4.5a1.25 1.25 0 0 0-1.25-1.25h-9A1.25 1.25 0 0 0 3.25 4.5v9A1.25 1.25 0 0 0 4.5 14.75h3.75" stroke="currentColor" stroke-width="1.125" stroke-linecap="round"/><path d="M6.25 7h5.5M6.25 10h2.5M12.75 10.5v5M10.25 13h5" stroke="currentColor" stroke-width="1.125" stroke-linecap="round"/></svg>',
  ...
  const groups = [
    ...
    { label: '工牌', items: [
      ...
      { page: 'device-management', route: 'management', label: '工牌管理', path: 'device-management/index.html#management', icon: icons.badgeManagement },
  ...
  function getCurrentNavigationPage() {
    ...
    if (pathname.includes('/device-management/')) {
      ...
      return `device-${['stores', 'badges', 'management', 'docks', 'dashboard', 'visits'].includes(route) ? route : 'stores'}`;
    }
