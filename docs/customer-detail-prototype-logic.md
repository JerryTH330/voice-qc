...
> 重要：客户聚合视图的详情跳转、录音覆盖和 AI 语音洞察资格规则，已由 `docs/客户聚合视图规则.md` 更新。两份文档冲突时，以新规则文档为准。
...
本页通过“客户聚合—最近一次录音摘要—AI 综合语音洞察—旅程核实”形成完整闭环。
...
统一画像只能重复“客户关注价格、空间”等静态结论，无法体现多线索聚合的价值。因此根据关联门店数自动分支：
...
左侧“最近一次录音摘要”只使用最近一通可分析录音。内容包括 AI 意向等级、AI 意向车系、本次意图、关键证据和录音来源（门店、时间、业务阶段）；不得使用全部录音的聚合结论填充该区域。

#### AI 综合语音洞察

右侧带“综合分析”标签，基于该客户全部可分析录音，并展示“综合 X 条线索 · Y 家有录音门店 · Z 条录音”的范围。至少两家有录音门店时显示“跨店差异与共性分析”；只有一家有录音门店且存在多条录音时显示“单店多次建联变化分析”。当前仅有一条可分析录音时，提示“当前仅有1条可分析录音，综合分析范围与左侧最近一次录音一致。”
...
1. 客户摘要中的关联线索、关联门店、录音覆盖和标签大多为静态演示数据；
